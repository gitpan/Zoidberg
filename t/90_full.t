...
$|++;
open ZOID, q#| bin/zoid --data-dirs=./share --cache-dir=./t/cache --rcfile=./t/zoidrc#;
...
print ZOID "echo ok 12 - redirection > test12; cat test12\n"; # 12
print ZOID "TEST='ok 13 - local environment' { print(\$TEST, \"\\n\") }\n"; # 13
print ZOID
	'{ for (qw/14 a 15 b 16 c/) { print "$_\n" } } | {/\d/}g | {chomp; $_ = "ok $_ - switches $_\n"}p',
	"\n"; # 14..16

#print ZOID "test 17 - rcfile with alias\n"; # 17
