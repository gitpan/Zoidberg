...
Disable hardcoded contexts like PERL, SH and CMD. This might be useful
...
filtering is applied rendering a lonesome dereference operator C<< -> >> with 
into C<< $self-> >>.
