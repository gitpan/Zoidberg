...
These can overrule other commandline switches.
...
B<zoid> also uses $XDG_CACHE_HOME to define the directory to write temporary files,
it defaults to F<$HOME/.cache>.
