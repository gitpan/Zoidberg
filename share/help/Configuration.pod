...
This hash stores config variables that have immidiate
influence on the Zoidberg parent object.
By default, it is saved to F<core.pd> .
...
the Zoidberg::Fish base class. By default it is saved to F<profile.pd> .
